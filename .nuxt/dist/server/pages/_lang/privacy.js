...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/_lang/privacy.vue?vue&type=template&id=8b5351dc&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"blogContent"},[_c('SocialShare',{attrs:{"title":_vm.title,"description":_vm.description,"name":_vm.name,"section":""}}),_vm._ssrNode(" <article><h1 class=\"blogCard__title\">"+_vm._ssrEscape("\n      "+_vm._s(_vm.title)+"\n    ")+"</h1> <h2 class=\"blogCard__desc\">"+_vm._ssrEscape("\n      "+_vm._s(_vm.description)+"\n    ")+"</h2> <h3 class=\"blogCard__date\">"+_vm._ssrEscape("\n      "+_vm._s(_vm.date)+"\n    ")+"</h3> <div>"+(_vm._s(_vm.content))+"</div></article>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/_lang/privacy.vue?vue&type=template&id=8b5351dc&

// EXTERNAL MODULE: ./components/social.vue + 4 modules
var social = __webpack_require__(146);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_lang/privacy.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var privacyvue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    const page = await __webpack_require__(302)(`./${store.state.locale}/privacy.md`);
...
// CONCATENATED MODULE: ./pages/_lang/privacy.vue?vue&type=script&lang=js&
 /* harmony default export */ var _lang_privacyvue_type_script_lang_js_ = (privacyvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/_lang/privacy.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _lang_privacyvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
