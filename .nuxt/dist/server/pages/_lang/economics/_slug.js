...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/_lang/economics/_slug.vue?vue&type=template&id=5019d3d6&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"blogContent"},[_c('SocialShare',{attrs:{"title":_vm.title,"description":_vm.description,"name":_vm.name,"section":"economics"}}),_vm._ssrNode(" <article><h1 class=\"blogCard__title\">"+_vm._ssrEscape("\n      "+_vm._s(_vm.title)+"\n    ")+"</h1> <h2 class=\"blogCard__desc\">"+_vm._ssrEscape("\n      "+_vm._s(_vm.description)+"\n    ")+"</h2> <h3 class=\"blogCard__date\">"+_vm._ssrEscape("\n      "+_vm._s(_vm.date)+"\n    ")+"</h3> <div>"+(_vm._s(_vm.content))+"</div></article>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/_lang/economics/_slug.vue?vue&type=template&id=5019d3d6&

// EXTERNAL MODULE: ./components/social.vue + 4 modules
var social = __webpack_require__(146);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_lang/economics/_slug.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var _slugvue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    const page = await __webpack_require__(148)(`./${store.state.locale}/economics/${slug}.md`);
  ...
  computed: {
    ogImage() {
      return `${"http://thedatatalks.in"}/images/economics/${this.name}/_thumbnail.png`;
    },
    ...
    hreflang() {
      ...
      return {
        ...
        rel: 'alternate',
        href: `${"http://thedatatalks.in" + (this.currentLanguage[0].code === 'en' ? '' : '/ta')}/economics/${this.name}`,
...
// CONCATENATED MODULE: ./pages/_lang/economics/_slug.vue?vue&type=script&lang=js&
 /* harmony default export */ var economics_slugvue_type_script_lang_js_ = (_slugvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/_lang/economics/_slug.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  economics_slugvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
