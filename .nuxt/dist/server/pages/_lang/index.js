...
var blogCardLayoutHome = __webpack_require__(270);
...
var economics_blogsEn = __webpack_require__(143);

// EXTERNAL MODULE: ./docs/ta/economics/blogsTa.js
var economics_blogsTa = __webpack_require__(144);

// EXTERNAL MODULE: ./docs/en/education/blogsEn.js
var education_blogsEn = __webpack_require__(145);

// EXTERNAL MODULE: ./docs/ta/education/blogsTa.js
var education_blogsTa = __webpack_require__(146);

// EXTERNAL MODULE: ./docs/en/others/blogsEn.js
var others_blogsEn = __webpack_require__(147);

// EXTERNAL MODULE: ./docs/ta/others/blogsTa.js
var others_blogsTa = __webpack_require__(148);
...
/* harmony default export */ var _langvue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    const page = await __webpack_require__(266)(`./${store.state.locale}/index.md`);
    ...
    /* , blogNameEconomics */
      ...
      const wholeMDPolitics = await __webpack_require__(137)(`./${store.state.locale}/politics/${blogNamePolitics}.md`);
      const resPolitics = fm(wholeMDPolitics.default);
      return resPolitics.attributes;
    }

    async function asyncImport2(blogNameEconomics) {
      const wholeMDEconomics = await __webpack_require__(134)(`./${store.state.locale}/economics/${blogNameEconomics}.md`);
    ...
    async function asyncImport3(blogNameEducation) {
      const wholeMDEducation = await __webpack_require__(135)(`./${store.state.locale}/education/${blogNameEducation}.md`);
      const resEducation = fm(wholeMDEducation.default);
      return resEducation.attributes;
    }

    async function asyncImport4(blogNameOthers) {
      const wholeMDOthers = await __webpack_require__(136)(`./${store.state.locale}/others/${blogNameOthers}.md`);
